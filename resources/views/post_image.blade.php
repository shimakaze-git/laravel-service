        ...
        <ul class="slides">
          ...
          <li>
            <div class="col-md-12">
              <blockquote>
                <h1>Hello! I'm Shimakaze</h1>
                <!--<p>Designer from Newcastle, UK.</p>-->
                <p>Engineer from Tokyo, Japan</p>
              </blockquote>
            </div>
          </li>
        </ul>
  ...
  <div class="container-fluid">
    <div class="row no-gutter">
      <div class="col-lg-3 col-md-6 col-sm-6 work">
        ...
        <a href="./service/post_image.php" class="work-box"> <img src="images/work-1.jpg" alt="">
        <div class="overlay">
